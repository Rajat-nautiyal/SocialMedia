        ...
        <div className="bg-gray-800 h-[90vh] w-[50%] max-md:w-[95%] max-md:h-[90%] rounded-lg shadow-lg p-4 relative z-20">
            <div className="flex justify-between items-center mb-2">
                <div className="flex items-center space-x-2">
                    <img 
                    src={`https://server-side-delta.vercel.app/streamId/${story.userId.userPic}`} 
            ...
            <div className="relative flex flex-col items-center h-full">
                ...
                <img ref={imageRef}
                    src={story.postPicturePath?`https://server-side-delta.vercel.app/streamId/${story.postPicturePath}`:generalBg}
